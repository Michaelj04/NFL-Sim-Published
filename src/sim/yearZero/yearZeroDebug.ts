...
export function buildYearZeroDebugExport(save: Pick<GameSave, "yearZero" | "collegeRoster" | "collegeTraining" | "collegeSeasonResults" | "collegeMorale" | "draftEvaluation" | "annualPipeline" | "annualTransferPortal" | "annualRecruiting" | "annualRecruitClass" | "annualRosterImportPlan" | "schoolProfiles" | "teams" | "schools" | "players" | "prospects">): YearZeroDebugExport | undefined {
  ...
  return {
    ...
    artifactCounts: {
      ...
      nflReserveStatuses: yearZero.nflReserveStatuses.length,
    ...
    invariants: {
      ...
      nflReserveStatusesPresent: yearZero.nflReserveStatuses.length >= save.teams.length,
      scoutingViewsCoverMultiplePools: ["high_school_recruit", "transfer", "draft_prospect", "nfl_free_agent"].every((subjectType) => yearZero.scoutingViews.some((view) => view.subjectType === subjectType)),
